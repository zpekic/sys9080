...
PORT0		EQU 0x00; 8 bit parallel port
PORT1		EQU 0x01; 8 bit parallel port
MASK_READY	EQU 0x02;
...
C020:	SUI	077H	;A=89H,C=1,P=0,S=1,Z=0
	...
	CZ	CPUER	;TEST "CZ"
	CPI	089H
	JMP C030;-----ORIGINAL: JZ	C030	;TEST FOR "CALLS" TAKING BRANCH
	CALL	CPUER
