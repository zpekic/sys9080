...
;       ORA  A
INIT:   STA  OCSW
        MVI  A,UART_INIT1           ;Initialize UART
        OUT  UART_CTRL				;1 stop bit, no parity, 8-bit char, 16x baud
        MVI  A,UART_INIT2			;enable receive and transmit
        OUT  UART_CTRL
        MVI  D,25					;25 empty lines
PATLOP:
        CALL CRLF
        DCR  D
        JNZ  PATLOP
...
OC3:    IN   UART_STATUS                ;Check status
        ...
        RET
;
CHKIO:  IN   UART_STATUS                ;*** CHKIO ***
        NOP                             ;STATUS BIT FLIPPED?
        ANI  UART_RX_FULL               ;MASK STATUS BIT
        RZ                              ;NOT READY, RETURN "Z"
        IN   UART_DATA                  ;READY, READ DATA
